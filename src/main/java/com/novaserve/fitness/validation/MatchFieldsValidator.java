...
public class MatchFieldsValidator implements ConstraintValidator<MatchFieldsValidation, Object> {
  private String field;
  private String fieldMatch;

  @Override
  public void initialize(MatchFieldsValidation constraintAnnotation) {

...
//    }
//
//    private List<UserBase> generateDummyUsers() {
...
//        User principal = dbHelper.user().seed(0).role(principalRole).build().save(User.class);
//
...
//    public void getUsers_shouldReturnPageFilteredByRoles_whenAdminRequest(Role principalRole, List<Role>
// filterByRoles)
//            throws Exception {
//        User principal = dbHelper.user().seed(0).role(principalRole).build().save(User.class);
//
